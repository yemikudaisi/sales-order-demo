frappe.pages['so-fulfillment'].on_page_load = function (wrapper) {
				...
				if (r.message) {
					...
					$.each(r.message, function (i, d) {
						table += `
                            ...
                            <tr class="order-items" data-order-id="${d.name}" style="display: none;">
																<td  colspan="2" />
                                <td colspan="4">
	...
	$(page.wrapper).find('.page-content').append(`
        <div class="result-list" style="padding: 5p"></div>
				<div class="list-paging-area level" style="padding-top: 5px; padding-left: 10px;">
